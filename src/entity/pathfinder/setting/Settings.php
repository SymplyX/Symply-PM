...
namespace pocketmine\entity\pathfinder\setting;

use pocketmine\entity\pathfinder\setting\rule\DefaultPathRules;
use pocketmine\entity\pathfinder\setting\rule\PathRules;
